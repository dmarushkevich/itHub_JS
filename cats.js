...
function render(array){
    ...
    table_elem.style.border = "thin dotted red"
    
    table_elem.setAttribute("border", "1")
    ...
    let th_img_link = document.createElement('th')

    th_id.innerText = 'Id'
    th_name.innerText = 'Name'
    th_age.innerText = 'Age'
    th_rate.innerText = 'Rate'
    th_favourite.innerText = 'Rate'
    th_description.innerText = 'Rate'
    th_img_link.innerText = 'Picture'
  

    tr_header.append(th_id,th_name, th_age, th_rate, th_favourite, th_description, th_img_link)
    ...
    for (let elem of array){
        ...
        let td_img_link = document.createElement('img')
        ...
        td_description.style.width = '400px'
        td_img_link.src = elem.img_link
        td_img_link.style.height = '200px'
        td_img_link.style.width = 'auto'
              


        tr_elem.append(td_id,td_name, td_age, td_rate, td_favourite, td_description, td_img_link)
